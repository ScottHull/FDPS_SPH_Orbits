...
rows_map = {
        ...
        "MEAN_DISK_ENTROPY_W_CIRC": "{Avg. $S_{disk}$ w/ circ. (J/kg/K)}",
        "MEAN_DISK_ENTROPY_WITHOUT_CIRC": "{Avg. $S_{disk}$ w/o circ. (J/kg/K)}",
        "DISK_DELTA_S_DUE_TO_ORBIT_CIRCULAR_FILTERED": "{Avg. $\Delta S_{circ}$ (J/kg/K)}",
