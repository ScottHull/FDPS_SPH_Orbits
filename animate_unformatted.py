...
to_path = "animate_unformatted"
sim, title = "500_half_earths", "Half-Earths"
...
def run():
    ...
    iterations = [i for i in iterations if f"{i}.png" not in os.listdir(to_path)]
