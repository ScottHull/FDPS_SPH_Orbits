...
path = "/home/theia/scotthull/1M_500kgm3/formatted_gi_new_eos_b_073_500kgm3_end_2900"
...
for time in np.arange(start_time, end_time + increment, increment):
    ...
    avg_disk_entropy.append(mean(disk_particles['entropy']))
    disk_particle_count.append(len(disk_particles['entropy']))
...
plt.savefig("vmf_from_formatted.png", formatted='png')
