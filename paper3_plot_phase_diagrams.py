...
iteration = 1800
runs = [
    # ('/home/theia/scotthull/Paper3_SPH/gi/500_b073_new/mars_citron_1vesc_b073_stewart_undiff', 'run 1'),
    ('/home/theia/scotthull/Paper3_SPH/gi/500_half_earths/mars_citron_1.4vesc_b073_stewart_undiff', 'run 2'),
    # ('', 'Mars')
]
...
def plot_phase_diagrams():
        ...
        for index, (path, t) in enumerate(runs):
            ...
            disk = disk[disk['tag'] % 2 == 0]  # only get silicate particles
...
plot_phase_diagrams()
plt.tight_layout()
legend = axs[-1].legend(loc='lower right', fontsize=14)
