...
runs = [
    [base_path + f"500_mars_b073_2v_esc", r"Mars ($b=0.73$, $1 v_{esc}$)", 600],
    [base_path + f"500_mars_b073_2v_esc", r"Mars ($b=0.73$, $2 v_{esc}$)", 600],
    [base_path + f"500_mars_b073_2v_esc", r"Mars ($b=0.50$, $1 v_{esc}$)", 600],
]
